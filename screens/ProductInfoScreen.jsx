    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white', paddingTop: Platform.OS == 'android' ? StatusBar.currentHeight : 0 }}>
            ...
            <ScrollView style={{ marginHorizontal: 5, }} showsVerticalScrollIndicator={false}>
                ...
                <Pressable onPress={() => addItemToCart(productInfo)} style={{ backgroundColor: '#101010', paddingHorizontal: 20, paddingVertical: 8, marginTop: 15, borderRadius: 20, alignItems: 'center' }}>
                    {
                        addedToCart ? (
                            <Text style={{ color: 'white', fontSize: 16, fontWeight: 500 }}>Added to cart</Text>
                        ) : (
